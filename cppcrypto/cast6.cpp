...
namespace cppcrypto
{
	...
	static inline void ks(int i, uint32_t& a, uint32_t& b, uint32_t& c, uint32_t& d, uint32_t& e, uint32_t& f, uint32_t& g, uint32_t& h, uint32_t* km, uint8_t* kr)
	{
		...
		printf("ks[%d]: %08x %08x %08x %08x %08x %08x %08x %08x\n", i, a,b,c,d,e,f,g,h);
#endif
	}
	...
	void cast6_256::encrypt_block(const uint8_t* in, uint8_t* out)
	{
		...
		printf("km: %08x %08x %08x %08x\n", km[24], km[25], km[26], km[27]);
		printf("kr: %02x %02x %02x %02x\n", kr[24], kr[25], kr[26], kr[27]);
#endif
		...
		printf("km: %08x %08x %08x %08x\n", km[28], km[29], km[30], km[31]);
		printf("kr: %02x %02x %02x %02x\n", kr[28], kr[29], kr[30], kr[31]);
#endif
		...
		printf("km: %08x %08x %08x %08x\n", km[36], km[37], km[38], km[39]);
		printf("kr: %02x %02x %02x %02x\n", kr[36], kr[37], kr[38], kr[39]);
#endif
		...
		printf("km: %08x %08x %08x %08x\n", km[40], km[41], km[42], km[43]);
		printf("kr: %02x %02x %02x %02x\n", kr[40], kr[41], kr[42], kr[43]);
#endif

...
#ifdef __SUNPRO_CC
inline static __m256i _mm256_castsi128_si256(__m128i val)
{
	__m256i res;
	return _mm256_insertf128_si256(res, val, 0);
}
inline static __m128i _mm256_castsi256_si128(__m256i val)
{
	return _mm256_extractf128_si256(val, 0);
}
#endif

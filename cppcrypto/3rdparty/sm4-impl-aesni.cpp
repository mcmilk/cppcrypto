...
#define Ipp32u uint32_t
#define Ipp32s int32_t
#define Ipp8u uint8_t
#define ENDIANNESS32(x) swap_uint32(x)
#define __ALIGN16 alignas(16)
#define __ALIGN64 alignas(64)
...
namespace
{
    alignas(16) Ipp32u SMS4_FK[4] = {
       0xA3B1BAC6,0x56AA3350,0x677D9197,0xB27022DC
    };

    /* CK[] constants */
    alignas(16) Ipp32u SMS4_CK[32] =
    {
    ...
    alignas(64) const Ipp8u SMS4_Sbox[16 * 16] = {
    ...
    alignas(16) static Ipp8u inpMaskLO[] = { 0x65,0x41,0xfd,0xd9,0x0a,0x2e,0x92,0xb6,0x0f,0x2b,0x97,0xb3,0x60,0x44,0xf8,0xdc };
    alignas(16) static Ipp8u inpMaskHI[] = { 0x00,0xc9,0x67,0xae,0x80,0x49,0xe7,0x2e,0x4a,0x83,0x2d,0xe4,0xca,0x03,0xad,0x64 };
    alignas(16) static Ipp8u outMaskLO[] = { 0xd3,0x59,0x38,0xb2,0xcc,0x46,0x27,0xad,0x36,0xbc,0xdd,0x57,0x29,0xa3,0xc2,0x48 };
    alignas(16) static Ipp8u outMaskHI[] = { 0x00,0x50,0x14,0x44,0x89,0xd9,0x9d,0xcd,0xde,0x8e,0xca,0x9a,0x57,0x07,0x43,0x13 };
    alignas(16) static Ipp8u encKey[] = { 0x63,0x63,0x63,0x63,0x63,0x63,0x63,0x63,0x63,0x63,0x63,0x63,0x63,0x63,0x63,0x63 };
    alignas(16) static Ipp8u maskSrows[] = { 0x00,0x0d,0x0a,0x07,0x04,0x01,0x0e,0x0b,0x08,0x05,0x02,0x0f,0x0c,0x09,0x06,0x03 };
    alignas(16) static Ipp8u lowBits4[] = { 0x0f,0x0f,0x0f,0x0f,0x0f,0x0f,0x0f,0x0f,0x0f,0x0f,0x0f,0x0f,0x0f,0x0f,0x0f,0x0f };
    alignas(16) static Ipp8u swapBytes[] = { 3,2,1,0, 7,6,5,4, 11,10,9,8, 15,14,13,12 };
...
#define MBS_SMS4  (16)
    ...
    */
    ...
    alignas(16) static Ipp8u ROL8[] = { 3,0,1,2,  7,4,5,6,  11,8,9,10,  15,12,13,14 };
    alignas(16) static Ipp8u ROL16[] = { 2,3,0,1,  6,7,4,5,  10,11,8,9,  14,15,12,13 };
    alignas(16) static Ipp8u ROL24[] = { 1,2,3,0,  5,6,7,4,  9,10,11,8,  13,14,15,12 };
...
bool sm4_impl_aesni::init(const unsigned char* key, block_cipher::direction direction)
{
    cpSMS4_SetRoundKeys_aesni(rk, key);
...
void sm4_impl_aesni::encrypt_block(const unsigned char* in, unsigned char* out)
{
    cpSMS4_ECB_aesni_x1(out, in, rk);
}

void sm4_impl_aesni::decrypt_block(const unsigned char* in, unsigned char* out)
{
    cpSMS4_ECB_aesni_x1(out, in, rk);
}

void sm4_impl_aesni::encrypt_blocks(const unsigned char* in, unsigned char* out, size_t n)
{
    cpSMS4_ECB_aesni_x8(out, in, static_cast<int>(n * 16), rk);
}

void sm4_impl_aesni::decrypt_blocks(const unsigned char* in, unsigned char* out, size_t n)
{
    cpSMS4_ECB_aesni_x8(out, in, static_cast<int>(n * 16), rk);
}

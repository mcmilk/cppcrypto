...
#ifndef DIGESTPPMOD_ALGORITHM_KMAC_HPP
#define DIGESTPPMOD_ALGORITHM_KMAC_HPP
 ...
 * digestppmod::kmac128 hasher(256);
 ...
 * digestppmod::kmac256 hasher(256);
 * hasher.set_key(R("@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_"));
 * hasher.absorb("The quick brown fox jumps over the lazy dog");
 * std::cout << hasher.hexdigest() << '\n';
 * @endcode
 ...
 * digestppmod::kmac128_xof hasher;
 * hasher.set_key(R"(@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_)");
 * hasher.absorb("The quick brown fox jumps over the lazy dog");
 ...
 * @par Example:\n
 * @code // Set key, absorb a string and squeeze 32 bytes of output
 * digestppmod::kmac256_xof hasher;
 * hasher.set_key(R"(@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_)");
 * hasher.absorb("The quick brown fox jumps over the lazy dog");
 * std::cout << hasher.hexsqueeze(32) << '\n';
 * @endcode
...
#endif // DIGESTPPMOD_ALGORITHM_KMAC_HPP
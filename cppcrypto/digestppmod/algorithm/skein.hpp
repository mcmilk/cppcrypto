...
#ifndef DIGESTPPMOD_ALGORITHM_SKEIN_HPP
#define DIGESTPPMOD_ALGORITHM_SKEIN_HPP
 ...
 * digestppmod::skein1024 hasher(256);
 ...
 * digestppmod::skein512 hasher(256);
 * hasher.absorb("The quick brown fox jumps over the lazy dog");
 * std::cout << hasher.hexdigest() << '\n';
 * @endcode
 *
 ...
 * digestppmod::skein256 hasher(512);
 * hasher.absorb("The quick brown fox jumps over the lazy dog");
 * std::cout << hasher.hexdigest() << '\n';
 * @endcode
 *
 ...
 * digestppmod::skein1024_xof hasher;
 * hasher.absorb("The quick brown fox jumps over the lazy dog");
 ...
 * @par Example:\n
 * @code // Absorb a string and squeeze 32 bytes of output
 * digestppmod::skein512_xof hasher;
 * hasher.absorb("The quick brown fox jumps over the lazy dog");
 * std::cout << hasher.hexsqueeze(32) << '\n';
 * @endcode
 *
 ...
 * @par Example:\n
 * @code // Absorb a string and squeeze 32 bytes of output
 * digestppmod::skein256_xof hasher;
 * hasher.absorb("The quick brown fox jumps over the lazy dog");
 * std::cout << hasher.hexsqueeze(32) << '\n';
 * @endcode
 *

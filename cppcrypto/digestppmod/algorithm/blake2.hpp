...
#ifndef DIGESTPPMOD_ALGORITHM_BLAKE2_HPP
#define DIGESTPPMOD_ALGORITHM_BLAKE2_HPP

#include "../hasher.hpp"
#include "detail/blake2_provider.hpp"
#include "mixin/blake2_mixin.hpp"

/// digestppmod namespace
 ...
 * digestppmod::blake2b hasher(256);
 ...
 * digestppmod::blake2xb hasher(256);
 * hasher.absorb("The quick brown fox jumps over the lazy dog");
 * std::cout << hasher.hexdigest() << '\n';
 * @endcode
 *
 ...
 * digestppmod::blake2xs hasher(512);
 * hasher.absorb("The quick brown fox jumps over the lazy dog");
 * std::cout << hasher.hexdigest() << '\n';
 * @endcode
 *
 ...
 * digestppmod::blake2xb_xof hasher;
 * hasher.absorb("The quick brown fox jumps over the lazy dog");
 ...
 * @par Example:\n
 * @code // Absorb a string and squeeze 32 bytes of output
 * digestppmod::blake2xs_xof hasher;
 * hasher.absorb("The quick brown fox jumps over the lazy dog");
 * std::cout << hasher.hexsqueeze(32) << '\n';
 * @endcode
 *
...
#endif // DIGESTPPMOD_ALGORITHM_BLAKE2_HPP
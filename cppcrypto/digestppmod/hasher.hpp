...
#ifndef DIGESTPPMOD_HASHER_HPP
#define DIGESTPPMOD_HASHER_HPP
 ...
 * See \ref digestppmod namespace description for description of supported hash functions with usage examples.
 *
...
class hasher : public Mixin<HashProvider>
{
	 ...
	 * cout << digestppmod::sha512(256).absorb(c, sizeof(c)).hexdigest() << std::endl;
	 * @endcode
	 */
	 ...
	 * std::cout << digestppmod::blake2b(256).absorb(str).hexdigest() << std::endl;
	 * @endcode
	 */
	 ...
	 * std::cout << digestppmod::sha256().absorb(file).hexdigest() << std::endl;
	 * @endcode
	 */
	template<typename T, typename std::enable_if<detail::is_byte<T>::value>::type* = nullptr>
	 ...
	 * std::cout << digestppmod::sha512().absorb(v.begin(), v.end()).hexdigest() << std::endl;
	 * @endcode
	 */
	 ...
	 * digestppmod::sha3(256).absorb("The quick brown fox jumps over the lazy dog").digest(buf, sizeof(buf));
	 * @endcode
	 */
	template<typename T, typename H=HashProvider,
		typename std::enable_if<detail::is_byte<T>::value && !detail::is_xof<H>::value>::type* = nullptr>
	 ...
	 * digestppmod::sha3(256).absorb("The quick brown fox jumps over the lazy dog").digest(back_inserter(v));
	 * @endcode
	 */
	template<typename OI, typename H=HashProvider, typename std::enable_if<!detail::is_xof<H>::value>::type* = nullptr>
	 ...
	 * std::cout << digestppmod::blake2b().absorb("The quick brown fox jumps over the lazy dog").hexdigest() << std::endl;
	 * @endcode
	 */
	template<typename H=HashProvider, typename std::enable_if<!detail::is_xof<H>::value>::type* = nullptr>
